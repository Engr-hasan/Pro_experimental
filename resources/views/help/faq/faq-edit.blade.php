    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{url('/faq-update',$data->id)}}" method="post" role="form" id="HowToUseFormId">
                  @csrf
                  <div class="row">
                    <div class="col-sm-12">
                      <!-- text input -->
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="faq_title" value="{{$data->faq_title}}" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="summary-ckeditor" rows="3" name="faq_description" required>{!! $data->faq_description !!}</textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
