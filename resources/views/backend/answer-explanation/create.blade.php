    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{route('answer-explanation.store')}}" method="post" role="form" id="subjectFormId">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="question_create_id" class="form-control" id="question_create_id" required>
                                        ...
                                        @foreach($questions as $question)
                                            <option class="form-group" value="{{ $question->id }}">{!! \Str::limit($question->question, '100') !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="topic" placeholder="Enter Your Topic" required></input>
                                </div>
                                <div class="form-group">
                                    <label>Explanation: <span class="text-danger">*</span></label>
                                    <textarea class="form-control" id="summary-ckeditor" rows="3" name="explanation" placeholder="Enter Your Question Here" required></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
